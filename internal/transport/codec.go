...
func newResponseLease(body io.ReadCloser) *responseLease {
	return &responseLease{body: body}
}

func (l *responseLease) decodeJSON(target any) error {
	if err := json.NewDecoder(l.body).Decode(target); err != nil {
		return err
	}
	return l.release()
}

func (l *responseLease) release() error {
	if l == nil || l.body == nil || l.released {
		return nil
	}
	l.released = true
	return l.body.Close()
